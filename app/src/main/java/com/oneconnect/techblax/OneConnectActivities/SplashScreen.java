        ...
        Thread thread = new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    oneConnect.initialize(SplashScreen.this, "awXjo9xnk56N7gZv.RWSR3Ot7B1TYqHO84hCYUQhpFNl3k9RxT"); // Put Your OneConnect API Key for Work Server
                    try {
                        Constants.FREE_SERVERS = oneConnect.fetch(false);
